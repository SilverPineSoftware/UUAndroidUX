...
class ViewAnimator(animationComposer: AnimationComposer) {
    ...
    class AnimationComposer {
        ...
        fun playOn(target: View): AnimatorString {
            this.target = target
            return ViewAnimator(this).play()?.let { AnimatorString(it, this.target) }
        }
    }
    ...
    companion object {
        fun getComposer(techniques: AnimationEffect): AnimationComposer {
